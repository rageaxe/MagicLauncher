//
//  DefineGestureButtonLayout.swift
//  MagicLauncher
//
...
struct DefineGestureButtonLayout {
    static func layout(containerView: UIView, innerView: UIView) {
        ...
        containerView.addConstraint(NSLayoutConstraint(item: innerView, attribute: .Right, relatedBy: .Equal, toItem: containerView, attribute: .Right, multiplier: 1, constant: -buttonMargin))
